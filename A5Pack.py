...
class A5Pack:
    ...
    VALID_CHUNKS = { # Flash dst addr, max valid size
        "A5 code":          (0x40020000, 0x00200000),
        "A5 voice":         (0x40200000, 0x05000000),
        "A5 Reserve1":      (0x479C0000, 0x00100000),
        "A5 Reserve2":      (0x47AC0000, 0x00100000),
        "A5 Reserve3":      (0x47BC0000, 0x00100000),
        "A5 selfcheck":     (0x47CC0000, 0x00132000),
        "A5 system":        (0x47E00000, 0x00020000),
        "A5 patch":         (0x47F00000, 0x000A5400),
        "A5 patch(5)":      (0x47E80000, 0x0014A800),
        "stm32 code":       (0x08010000, 0x00100000),
        "gd32 code":        (0x08010000, 0x00100000),
        "stm32F030 code":   (0x08002800, 0x0000D800),
        "gdf32F030 code":   (0x08002800, 0x0000D800),
        "Z-A5 bootloader":  (0x40000000, 0x00020000),
        # Desktop?
        "A5_s code":        (0x40020000, 0x00132000),
        "A5_s voice":       (0x40200000, 0x05000000),
        "A5_s Reserve1":    (0x479C0000, 0x00100000),
        "A5_s Reserve2":    (0x47AC0000, 0x00100000),
        "A5_s selfcheck":   (0x47CC0000, 0x00132000),
        "Z-A5_s bootloader":(0x40000000, 0x00020000),
        # Explorer
        "A5_3m Reserve1":   (0x42600000, 0x00100000),
        "A5_3m Reserve2":   (0x42700000, 0x00100000),
        "A5_3m Reserve3":   (0x42800000, 0x00100000),
        "A5_3m selfcheck":  (0x42900000, 0x00132000),
        "A5_3m system":     (0x42A40000, 0x00020000),
        "A5_3m patch":      (0x42200000, 0x00200000),
        # Delux
        "A5_7x patch":      (0x472C0000, 0x00300000),
        "A5_7x multi patch":(0x401E0000, 0x00020000),
        "A5_7x lower patch":(0x475C0000, 0x00200000),
        "A5_7x upper patch":(0x477C0000, 0x00200000)
    }
